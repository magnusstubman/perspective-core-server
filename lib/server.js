...
var api = function(server) {
  ...
  return {
    ...
    getErrorObject: function(errorMessage, successMessage) {
      return {
        errors: errorMessage,
        success: successMessage
      }
    },
    serverError: function(res, next) {
      res.send(500, serverAPI.getErrorObject("Something went wrong, could not fulfil the request"));
      next();
    }
  }
};
